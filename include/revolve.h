...
public:
    ...
    void openCheck(std::string filename, std::shared_ptr<WavesElastic2D<T>> waves, char flag);
    ...
    void readCheck(std::shared_ptr<WavesElastic2D<T>> waves);
    void readCheck(std::shared_ptr<WavesElastic3D<T>> waves);
