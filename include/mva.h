...
public:
    ...
    void crossCorr(T *wsx, T *wsz, int pads, std::shared_ptr<WavesElastic2D_DS<T>> waves_bw, std::shared_ptr<ModelElastic2D<T>> model, T *adjsrcxx, T *adjsrczz, T *adjsrcxz);
    void calcAdjointsource(T *adjsrcxx, T *adjsrczz, T *adjsrcxz, T* wrx, T* wrz, int padr, std::shared_ptr<ModelElastic2D<T>> model);
    void insertAdjointsource(std::shared_ptr<WavesElastic2D_DS<T>> waves_bw, T* adjsrcxx, T* adjsrczz, T* adjsrcxz, std::shared_ptr<ModelElastic2D<T>> model);
