...
//// =============== 3D ACOUSTIC WEMVA CLASS =============== //
////
//template<typename T>
//WemvaAcoustic3D<T>::WemvaAcoustic3D() {
//    // Set default parameters
//    apertx = -1;
//    aperty = -1;
//
...
//
//template<typename T>
//WemvaAcoustic3D<T>::WemvaAcoustic3D(MPImodeling *mpi): Wemva<T>(mpi) {
//    // Set default parameters
//    apertx = -1;
//    aperty = -1;
//
...
//
//template<typename T>
//void WemvaAcoustic3D<T>::runGrad() {
//    MPImodeling *mpi = this->getMpi();
...
//
//template<typename T>
//void WemvaAcoustic3D<T>::runBsproj() {
//    MPImodeling *mpi = this->getMpi();
//	T vpsum = 0.0; // Sum over splines
...
//	float *vpproj= (float *) calloc(nc, sizeof(float));
//	if(vpproj==NULL){
//		rs_error("WemvaAcoustic3D<T>::runBsproj(): Not enough memory to allocate projection array (vpproj)");
//	}
//	float *rhoproj= (float *) calloc(nc, sizeof(float));
//	if(rhoproj==NULL){
//		rs_error("WemvaAcoustic3D<T>::runBsproj(): Not enough memory to allocate projection array (rhoproj)");
//	}
//
//    if(mpi->getRank() == 0) {
//		// Master
...
//		global_stack= (float *) calloc(nc, sizeof(float));
//		if(global_stack==NULL){
//			rs_error("WemvaAcoustic3D<T>::runBsproj(): Not enough memory to allocate global stack array");
//		}
//
//		/* Starting reduce operation */
//		MPI_Reduce(vpproj, global_stack, nc, MPI_FLOAT, MPI_SUM, 0, MPI_COMM_WORLD);   
...
//
//template<typename T>
//int WemvaAcoustic3D<T>::setInitial(double *x, std::string vpfile, std::string rhofile, std::string sourcefile)
//{
...
//            break;
//        default:
//            rs_error("WemvaAcoustic3D<T>::setInitial(): Unknown parameterisation."); 
//            break;
//    }
//
//    return Npar;
...
//
//template<typename T>
//void WemvaAcoustic3D<T>::saveResults(int iter)
//{
//    std::string name;
//    std::string dir;
//    dir = RESULTDIR;
...
//
//template<typename T>
//void WemvaAcoustic3D<T>::saveLinesearch(double *x)
//{
//    // Models
...
//        int Nmute = (mute->getGeom())->getNtot();
//        N = (lsmodel->getGeom())->getNtot();
//        if(N != Nmute) rs_error("WemvaAcoustic3D<T>::saveLinesearch(): Geometry in Mutefile does not match geometry in the model.");
//        mute->readModel();
//        vpmutedata = mute->getVp();
...
//            break;
//        default:
//            rs_error("WemvaAcoustic3D<T>::saveLinesearch(): Unknown parameterisation."); 
//            break;
//    }
//    // Source wavelet
//    Ns = lssource->getNt();
...
//
//template<typename T>
//void WemvaAcoustic3D<T>::readMisfit(double *f)
//{
//    // Data misfit
//    *f = 0.0;
//    std::shared_ptr<rockseis::File> Fmisfit (new rockseis::File());
...
//
//template<typename T>
//void WemvaAcoustic3D<T>::readGrad(double *g)
//{
//    int i;
//    int N,Ns,Npar=0;
//    float *g_in;
...
//            break;
//        default:
//            rs_error("WemvaAcoustic3D<T>::readGrad(): Unknown parameterisation."); 
//            break;
//    }
//    if(update_source){
//        Ns = sourcegrad->getNt();
...
//
//template<typename T>
//void WemvaAcoustic3D<T>::combineGradients()
//{
//    // Gradients
...
//
////template<typename T>
////void WemvaAcoustic3D<T>::applySrcilum()
////{
////    if(this->getSrcilum()){
////        // Models
...
//
//template<typename T>
//void WemvaAcoustic3D<T>::applyMute()
//{
//    if(!Mutefile.empty()){
//        // Models
//        std::shared_ptr<rockseis::ModelAcoustic3D<T>> model;
...
//
//template<typename T>
//void WemvaAcoustic3D<T>::computeRegularisation(double *x)
//{
//    // Models
...
//            break;
//        default:
//            rs_error("WemvaAcoustic3D<T>::computeRegularization(): Unknown parameterisation."); 
//            break;
//    }
//    // Computing misfit
//    double M; 
...
//    if(rhoproj==NULL){
//        rs_error("WemvaElastic2D<T>::runBsproj(): Not enough memory to allocate projection array (rhoproj)");
//    }
//
//    if(mpi->getRank() == 0) {
//		// Master
...
//}
//
//// =============== 3D ELASTIC WEMVA CLASS =============== //
////
//template<typename T>
//WemvaElastic3D<T>::WemvaElastic3D() {
//    // Set default parameters
//    apertx = -1;
//    aperty = -1;
//    sourcetype = 0;
...
//
//template<typename T>
//WemvaElastic3D<T>::WemvaElastic3D(MPImodeling *mpi): Wemva<T>(mpi) {
//    // Set default parameters
//    apertx = -1;
//    aperty = -1;
//    sourcetype = 0;
...
//
//template<typename T>
//void WemvaElastic3D<T>::runBsproj() {
//    MPImodeling *mpi = this->getMpi();
//	T vpsum = 0.0; // Sum over splines
//	T vssum = 0.0; // Sum over splines
//	T rhosum = 0.0; // Sum over splines
...
//    vpproj= (float *) calloc(nc, sizeof(float));
//    if(vpproj==NULL){
//        rs_error("WemvaElastic3D<T>::runBsproj(): Not enough memory to allocate projection array (vpproj)");
//    }
//    vsproj= (float *) calloc(nc, sizeof(float));
//    if(vsproj==NULL){
//        rs_error("WemvaElastic3D<T>::runBsproj(): Not enough memory to allocate projection array (vsproj)");
//    }
//    rhoproj= (float *) calloc(nc, sizeof(float));
//    if(rhoproj==NULL){
//        rs_error("WemvaElastic3D<T>::runBsproj(): Not enough memory to allocate projection array (rhoproj)");
//    }
//
//    if(mpi->getRank() == 0) {
//		// Master
...
//		global_stack= (float *) calloc(nc, sizeof(float));
//		if(global_stack==NULL){
//			rs_error("WemvaElastic3D<T>::runBsproj(): Not enough memory to allocate global stack array");
//		}
//
//        std::shared_ptr<File> Fout (new File());
//        if(update_vp){
...
//		
//template<typename T>
//int WemvaElastic3D<T>::setInitial(double *x, std::string vpfile, std::string vsfile, std::string rhofile, std::string sourcefile)
//{
...
//            break;
//        default:
//            rs_error("WemvaElastic3D<T>::setInitial(): Unknown parameterisation."); 
//            break;
//    }
//
//    return Npar;
...
//
//template<typename T>
//void WemvaElastic3D<T>::saveResults(int iter)
//{
//    std::string name;
//    std::string dir;
//    dir = RESULTDIR;
...
//
//template<typename T>
//void WemvaElastic3D<T>::saveLinesearch(double *x)
//{
//    // Models
...
//        int Nmute = (mute->getGeom())->getNtot();
//        N = (lsmodel->getGeom())->getNtot();
//        if(N != Nmute) rs_error("WemvaElastic3D<T>::saveLinesearch(): Geometry in Mutefile does not match geometry in the model.");
//        mute->readModel();
//        vpmutedata = mute->getVp();
//        vsmutedata = mute->getVs();
//        rhomutedata = mute->getR();
...
//
//template<typename T>
//void WemvaElastic3D<T>::readMisfit(double *f)
//{
//    // Data misfit
//    *f = 0.0;
//    std::shared_ptr<rockseis::File> Fmisfit (new rockseis::File());
...
//
//template<typename T>
//void WemvaElastic3D<T>::readGrad(double *g)
//{
//    int i;
//    int N,Ns,Npar=0;
//    float *g_in;
...
//            break;
//        default:
//            rs_error("WemvaElastic3D<T>::readGrad(): Unknown parameterisation."); 
//            break;
//    }
//    if(update_source){
//        Ns = sourcegrad->getNt();
...
//
//template<typename T>
//void WemvaElastic3D<T>::combineGradients()
//{
//    // Gradients
...
//
//template<typename T>
//void WemvaElastic3D<T>::applyMute()
//{
//    if(!Mutefile.empty()){
//        // Models
...
//
//template<typename T>
//void WemvaElastic3D<T>::computeRegularisation(double *x)
//{
//    // Models
...
//            break;
//        default:
//            rs_error("WemvaElastic3D<T>::computeRegularization(): Unknown parameterisation."); 
//            break;
//    }
//    // Computing misfit
//    double M; 
...
//template class WemvaAcoustic3D<float>;
//template class WemvaAcoustic3D<double>;
//
//template class WemvaElastic2D<float>;
//template class WemvaElastic2D<double>;
//
//template class WemvaElastic3D<float>;
//template class WemvaElastic3D<double>;
