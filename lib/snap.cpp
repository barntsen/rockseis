...
template<typename T>
Snapshot2D<T>::Snapshot2D(std::shared_ptr<WavesPoroelastic2D<T>> waves, int snapinc)
{
    int _nx, _ny, _nz;
    T _dx, _dy, _dz; 
    T _ox, _oy, _oz; 
...
template<typename T>
Snapshot2D<T>::Snapshot2D(std::shared_ptr<WavesElastic2D_DS<T>> waves, int snapinc)
{
    int _nx, _ny, _nz;
    T _dx, _dy, _dz; 
    T _ox, _oy, _oz; 
...
template<typename T>
Snapshot2D<T>::Snapshot2D(std::shared_ptr<WavesViscoelastic2D<T>> waves, int snapinc)
{
    int _nx, _ny, _nz;
    T _dx, _dy, _dz; 
    T _ox, _oy, _oz; 
...
template<typename T>
Snapshot2D<T>::Snapshot2D(std::shared_ptr<WavesVti2D<T>> waves, int snapinc)
{
    int _nx, _ny, _nz;
    T _dx, _dy, _dz; 
    T _ox, _oy, _oz; 
...
template<typename T>
Snapshot3D<T>::Snapshot3D(std::shared_ptr<WavesElastic3D_DS<T>> waves, int snapinc)
{
    int _nx, _ny, _nz;
    T _dx, _dy, _dz; 
    T _ox, _oy, _oz; 
...
template<typename T>
Snapshot3D<T>::Snapshot3D(std::shared_ptr<WavesOrtho3D<T>> waves, int snapinc)
{
    int _nx, _ny, _nz;
    T _dx, _dy, _dz; 
    T _ox, _oy, _oz; 
