...
template<typename T>
Image2D<T>::Image2D(std::string _imagefile, std::shared_ptr<ModelViscoelastic2D<T>> model, int nhx, int nhz): Model<T>(2)
{
   long int _nx, _ny, _nz;
   T _dx, _dy, _dz; 
   T _ox, _oy, _oz; 
...
template<typename T>
Image2D<T>::Image2D(std::string _imagefile, std::shared_ptr<ModelVti2D<T>> model, int nhx, int nhz): Model<T>(2)
{
   long int _nx, _ny, _nz;
   T _dx, _dy, _dz; 
   T _ox, _oy, _oz; 
