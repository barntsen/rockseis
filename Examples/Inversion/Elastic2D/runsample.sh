...
sfspike <Vp2d.rsf k3=25 l3=26 k1=30 l1=35 mag=0. | sfsmooth rect1=5 rect3=5 out=stdout > pert.rsf
...
sfspike <Vs2d.rsf k3=25 l3=26 k1=10 l1=15 mag=0. | sfsmooth rect1=5 rect3=5 out=stdout > pert.rsf
...
sfspike <Rho2d.rsf k3=25 l3=26 k1=20 l1=25 mag=-100. | sfsmooth rect1=5 rect3=5 out=stdout > pert.rsf
